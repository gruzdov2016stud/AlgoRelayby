...
import nodes.registration.LSVC;
...
//----------------------------------------------------todo Узел ParseQuality pq---------------------------------------//
        ...
        logicalNodes.add(pq);//добавление его в логический узел
...
//----------------------------------------------------todo Узел PTOC ptoc1--------------------------------------------//
        ...
        ptoc1.getAutomaticAccelearation().getCtIVal().setValue(true); //режим автоматического ускорения(вводится для всех направленных ступеней)
...
//----------------------------------------------------todo Узел PTOC ptoc2--------------------------------------------//
        ...
        ptoc2.getAutomaticAccelearation().getCtIVal().setValue(true); //режим автоматического ускорения(вводится для всех направленных ступеней)
